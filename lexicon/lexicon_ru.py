LEXICON_RU : dict[str, str] = {
    '/start': 'Cithia приветствует тебя странник, чем я могу помочь тебе?\nБольше информации о моих способностях по команде /help',
    ...
    'start_game': "Я хочу сыграть в камень, ножницы, бумага 🎲",
    'rock': 'Камень 🗿',
    'paper': 'Бумага 📜',
    'scissors': 'Ножницы ✂',
    'yes_button': 'Давай!',
...
LEXICON_COMMANDS_RU: dict[str, str] = {
                '/game': 'Play with rock, scissors, paper with Cythia',
